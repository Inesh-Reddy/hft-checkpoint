...
type TickerUpdate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Symbo         string                 `protobuf:"bytes,1,opt,name=symbo,proto3" json:"symbo,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TickerUpdate) GetSymbo() string {
	if x != nil {
		return x.Symbo
	}
	return ""
...
const file_ticker_proto_rawDesc = "" +
	...
	"\x05symbo\x18\x01 \x01(\tR\x05symbo2\x95\x01\n" +
	"\rTickerService\x12?\n" +
	"\x10SubscribeToToken\x12\x15.ticker.TickerRequest\x1a\x14.ticker.TickerUpdate\x12C\n" +
	"\x14UnSubscribeFromToken\x12\x15.ticker.TickerRequest\x1a\x14.ticker.TickerUpdateB\x0eZ\fproto/tickerb\x06proto3"
...
var file_ticker_proto_depIdxs = []int32{
	0, // 0: ticker.TickerService.SubscribeToToken:input_type -> ticker.TickerRequest
	0, // 1: ticker.TickerService.UnSubscribeFromToken:input_type -> ticker.TickerRequest
	1, // 2: ticker.TickerService.SubscribeToToken:output_type -> ticker.TickerUpdate
	1, // 3: ticker.TickerService.UnSubscribeFromToken:output_type -> ticker.TickerUpdate
